...
class Survey_Maker {
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'wp_ajax_ays_surveys_export_json', $plugin_admin, 'ays_surveys_export_json' );
		...
		// Send test Mail
		$this->loader->add_action( 'wp_ajax_ays_survey_send_testing_mail', $plugin_admin, 'ays_survey_send_testing_mail' );
        $this->loader->add_action( 'wp_ajax_nopriv_ays_survey_send_testing_mail', $plugin_admin, 'ays_survey_send_testing_mail' );
