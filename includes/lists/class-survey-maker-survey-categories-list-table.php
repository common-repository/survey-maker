...
class Survey_Categories_List_Table extends WP_List_Table {
    ...
    public function __construct( $plugin_name ) {
        ...
        parent::__construct( array(
            'singular' => __( 'Survey Category', $this->plugin_name ), //singular name of the listed records
            'plural'   => __( 'Survey Categories', $this->plugin_name ), //plural name of the listed records
    ...
    public static function get_item_by_id( $id ) {
        ...
        $sql = "SELECT * FROM " . $wpdb->prefix . SURVEY_MAKER_DB_PREFIX . "survey_categories WHERE id=" . esc_sql( intval( $id ) );
    ...
    public function add_or_edit_item(){
        ...
        if( isset( $_POST["survey_category_action"] ) && wp_verify_nonce( $_POST["survey_category_action"], 'survey_category_action' ) ){
    ...
    public function no_items() {
        echo __( 'There are no survey categories yet.', $this->plugin_name );
    }
    ...
    function column_items_count( $item ) {
        global $wpdb;
        $sql = "SELECT COUNT(*) 
                FROM " . $wpdb->prefix . SURVEY_MAKER_DB_PREFIX . "survey_categories c
                JOIN " . $wpdb->prefix . SURVEY_MAKER_DB_PREFIX . "surveys s
    ...
    function get_columns() {
        $columns = array(
            ...
            'items_count'   => __( 'Surveys Count', $this->plugin_name ),
